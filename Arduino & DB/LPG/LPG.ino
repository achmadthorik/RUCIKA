...
String url = "http://192.168.43.105/RUCIKA/add_data.php?asap=";
...
void setup() {
  ...
  USE_SERIAL.setDebugOutput(false);
   ...
   for(uint8_t t = 4; t > 0; t--) {
    ...
    WiFi.mode(WIFI_STA);
    WiFiMulti.addAP("kenjeran", "suroboyo"); // Sesuaikan SSID dan password ini
...
void loop() {
  ...
  bacasensor = digitalRead(sensorPin);//api
